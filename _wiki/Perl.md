...
## 개요
* 설계자: [Larry Wall](https://en.wikipedia.org/wiki/Larry_Wall){:target="_blank"}
* 라이선스: Artistic License 1.0 or GNU General Public License(GPL)
* 구현언어: C
* 웹페이지:
  * [https://www.perl.org/](https://www.perl.org/){:target="_blank"}
  * [awesome-perl](https://github.com/hachiojipm/awesome-perl){:target="_blank"}
  * [매뉴얼](http://perldoc.perl.org/perl.html){:target="_blank"}
...
## 문법
* Perl5
* 좋은 말은 모두 가져다 붙인것 같습니다. [강력하고 안정적이고...](https://www.perl.org/about.html){:target="_blank"}
  * 전에 썼었는데, 안쓴지 몇년 되서 한번 훑어 보려합니다.
* 사용하는 [shebang](http://lua-users.org/lists/lua-l/2015-01/msg00633.html){:target="_blank"}은 `#!/usr/bin/env perl `
